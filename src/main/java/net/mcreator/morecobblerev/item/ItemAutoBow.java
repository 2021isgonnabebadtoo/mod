...
public class ItemAutoBow extends ElementsMoreCobblerev.ModElement {
	@GameRegistry.ObjectHolder("morecobblerev:autobow")
	public static final Item block = null;
	public static final int ENTITYID = 4;
	public ItemAutoBow(ElementsMoreCobblerev instance) {
		super(instance, 24);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityArrowCustom.class)
				.id(new ResourceLocation("morecobblerev", "entitybulletautobow"), ENTITYID).name("entitybulletautobow").tracker(64, 1, true).build());
	}

	@Override
	@SideOnly(Side.CLIENT)
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("morecobblerev:autobow", "inventory"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityArrowCustom.class, renderManager -> {
			return new RenderSnowball(renderManager, new ItemStack(Items.STICK, (int) (1)).getItem(), Minecraft.getMinecraft().getRenderItem());
		});
	}
