...
import net.mcreator.morecobblerev.procedure.ProcedureP;
...
public class GuiPray extends ElementsMoreCobblerev.ModElement {
	public static int GUIID = 2;
	public static HashMap guistate = new HashMap();
	public GuiPray(ElementsMoreCobblerev instance) {
		super(instance, 12);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("morecobblerev:textures/pray.png");
		@Override
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 16, this.guiTop + 20, 140, 20, "Detonar"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureP.executeProcedure($_dependencies);
			}
		}
	}
