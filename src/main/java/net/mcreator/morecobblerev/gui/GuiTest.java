...
package net.mcreator.morecobblerev.gui;
...
import net.mcreator.morecobblerev.procedure.ProcedureRemovecobble;
...
public class GuiTest extends ElementsMoreCobblerev.ModElement {
	public static int GUIID = 1;
	public static HashMap guistate = new HashMap();
	public GuiTest(ElementsMoreCobblerev instance) {
		super(instance, 7);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 7, 57) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				MoreCobblerev.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("morecobblerev:textures/test.png");
		@Override
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 21, this.guiTop + 7, 130, 20, "Delete item(s)"));
		}

		@Override
		protected void actionPerformed(GuiButton button) {
			MoreCobblerev.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
		...
		if (buttonID == 0) {
			{
				...
				ProcedureRemovecobble.executeProcedure($_dependencies);
			}
		}
	}
